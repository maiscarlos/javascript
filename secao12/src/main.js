...
class App {
    ...
    async adicionarRepositorio(evento){
        ...
        if(input.length === 0){
            return; // sempre vai sair da função
        }
        ...
        try{
            ...
            let {name, description, html_url, owner:{avatar_url}} = response.data; //desistructuring
            ...
            //Remove msg de erro pre existente
    ...
    apresentarBuscando(){       
        ...
        let txtBuscando = document.createTextNode(`Buscando ${input}...`);
