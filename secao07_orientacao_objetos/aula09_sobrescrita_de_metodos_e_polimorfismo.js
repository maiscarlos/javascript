...
- Porlimorfismos - Dois objetos do mesmo tipo tendo comportamentos diferentes.
*/
class Funcao{
...
class Pessoa{
    ...
    set nome_completo(nome_completo){
        ...
        // remove o primeiro elemento [0] do array e o retorna..
        this._nome = nome_completo.shift();
        // junta os elementos restantes do array em uma string..
...
const f1 = new Funcionario('Paula', 'Fernandes', 'paula@gmail.com', '123.456.789-33', prog, 'F9083df');

const c1 = new Cliente('Pedro', 'Silveira', 'pedro@gmail.com', '903.244.222-34', 45669.09);

f1.imprimir_dados(); // Pessoa

c1.imprimir_dados(); // Pessoa  nao imprime a funcao e salario
